...
class HospitalVendingMachine(VendingMachine):
    ...
    def print_days_until_maintenance(self):
        print(f"Days until vending machine maintenance: {self.days_until_maintenance}")
        

class SchoolVendingMachine(VendingMachine):

    snack_prices = {"candy": 2.01, 
                    "soda": 1.51, 
                    "chips": 3.01, 
                    "cookies": 3.51}
    student_debt = {"Mihael": 3.41,
                    "Tina": 2.23,
                    "Lora": 1.07}
    ...
    def print_student_debt(self, student_name):
        print(f"Debt of student {student_name} is {SchoolVendingMachine.student_debt[student_name]}.")
